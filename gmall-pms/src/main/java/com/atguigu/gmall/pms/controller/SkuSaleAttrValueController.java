...
public class SkuSaleAttrValueController {
    ...
    public Resp<List<SkuSaleAttrValueEntity>>  querySkuBySkuId(@PathVariable("skuId") Long skuId){
        List<SkuSaleAttrValueEntity> skuSaleAttrValueEntity = this.skuSaleAttrValueService.list(new QueryWrapper<SkuSaleAttrValueEntity>().eq("sku_id", skuId));
        return Resp.ok(skuSaleAttrValueEntity);
    ...
    /**
     * 根据spuId查询 销售属性 pms_sku_sale_attr_value
     */



    @GetMapping("{spuId}")
  public Resp<List<SkuSaleAttrValueEntity>>
     querySaleAttrBySpuId(@PathVariable("spuId") Long spuId ){

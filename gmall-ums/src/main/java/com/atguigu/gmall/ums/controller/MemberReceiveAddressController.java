...
public class MemberReceiveAddressController {
   ...
   public Resp<List<MemberReceiveAddressEntity>> queryAddressesByUserId(@PathVariable("userId") Long userId){
        List<MemberReceiveAddressEntity> memberReceiveAddressEntity = this.memberReceiveAddressService.list(new QueryWrapper<MemberReceiveAddressEntity>().eq("member_id", userId));
        return Resp.ok(memberReceiveAddressEntity);
